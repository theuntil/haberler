...
{hasGalleryImages && (
  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
    {images!.slice(0, 6).map((img, index) => {
      ...
      const isLastVisible = index === 5 && remaining > 0;
...
>
            ...
            {/* COUNTER */}
            <div className="absolute top-6 left-1/2 -translate-x-1/2 text-white text-sm bg-black/60 px-4 py-1 rounded-full backdrop-blur-md">
