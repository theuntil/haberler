...
Sosyal medyada “Yunus Seyyah” adıyla tanınan Yunus Okan hakkında çeşitli dolandırıcılık ve mağduriyet iddiaları saha önce de kamuoyuna yansımıştı.

İddia sahipleri, Yunus Okan'ın güven ilişkisi kurarak farklı gerekçelerle para talep ettiğini, kendilerine kredi çektirdiğini ve dolandırıldıklarını iddia ettiler.

Yunus Okan yaptığı açıklamada yurt dışına yerleştiğini belirtse de, hakkında verilen yakalama ve 2 yıl 1 aylık mahkeme kararı nedeniyle yurt dışına kaçtığı gün gibi aşikar.

Kuzeybatı Haber olarak Yunus Okan'a ulaştık ve cevap hakkı sunduk, lakin kendisinden bir cevap alamadık.

Her geçen gün Yunus Okan'ın kendisini dolandırdığı kişi sayısı artmakta ve mağdur olduğunu iddia eden kişiler, Yunus Okan'ın yurt dışına kaçıp ceza almamasından dolayı sıklıkla rahatsızlıklarını dile getiriyor. Türk adaleti her zaman yerini bulur. Devlet büyüklerimizin, hâkim ve savcılarımızın var gücüyle çalıştıklarını da biliyoruz. Bu sebeple biz de basın organı olarak iddia edilen mağduriyet olaylarına ışık tutmak, insanları bilinçlendirmek için var gücümüzle araştırıyoruz.

Yunus Okan Dosyası ile ilgili tüm medya ve kanıtları toplu şekilde sayfada yer alan medya kısmından inceleyebilirsiniz.

Bu haber adalet bakanlığının vermiş olduğu mahkeme kararları doğrultusunda ve mağdurların iddialarının derlenmesi ile yapılmıştır. İlgili tarafların yanıt hakkı saklıdır.
  </p>
